            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form action="{{ url('admin/manager/edit',$getRecord->id) }}" class="form-horizontal" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="manager_name" required
                                            placeholder="Enter Manager Name" value="{{ $getRecord->manager_name }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="manager_email" required
                                            placeholder="Enter Manager Email" value="{{ $getRecord->manager_email }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="manager_mobile" required
                                            placeholder="Enter Manager Mobile Number" value="{{ $getRecord->manager_number }}">
