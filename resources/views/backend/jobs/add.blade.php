                        ...
                        <form action="{{ url('admin/employees/add') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="job_title" required placeholder="Enter Job Title" value="{{ old('job_title') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="min_salary"  placeholder="Enter Min salary"  value="{{ old('min_salary') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" name="max_s" required  placeholder="Enter Email ID" value="{{ old('email') }}">
