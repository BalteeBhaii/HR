            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form action="{{ url('admin/job_grades/add') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="grade_level"
                                            value="{{ old('grade_level') }}" placeholder="Job Grade ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="lowest_sal"
                                            value="{{ old('lowest_sal') }}" placeholder="Lowest Salary ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="highest_sal"
                                            value="{{ old('highest_sal') }}" placeholder="Highest Salary ">
